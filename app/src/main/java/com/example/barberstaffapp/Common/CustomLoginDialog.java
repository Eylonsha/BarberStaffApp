...
public class CustomLoginDialog {
    ...
    public IDialogClockListener iDialogClockListener;
    ...
    public void showLoginDialog(String title, String positiveText, String negativeText, Context context, IDialogClockListener iDialogClockListener) {
        this.iDialogClockListener = iDialogClockListener;
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                iDialogClockListener.onClickPositiveButton(dialog, edt_user.getText().toString(), edt_password.getText().toString());
            }
        });
        ...
        btn_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iDialogClockListener.onClickNegativeButton(dialog);
            }
        });
