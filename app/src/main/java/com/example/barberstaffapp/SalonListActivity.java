...
public class SalonListActivity extends AppCompatActivity implements IonLoadCountSalon, IBranchLoadListener, IUserLoginRememberListener, IGetBarberListener {
    ...
    private void loadSalonBaseOnCity(String name) {
        FirebaseFirestore.getInstance().collection("AllSalon").document(name)
            ...
            public void onFailure(@NonNull Exception e) {
                iBranchLoadListener.onBranchLoadFaild(e.getMessage());
            }
        });
    ...
    @Override
    public void onBranchLoadFaild(String message) {
    ...
    public void onUserLoginSuccess(String user) {
        ...
        Paper.book().write(Common.SALON_KEY, new Gson().toJson(Common.selectSalon));
    }
}